    ...
    <Box className={styles.overlay}>
      ...
      >
        ...
        <DialogContent className={styles.scrollableContent}>
          ...
          >
            Last Revised: December 16, 2023 <br />
            ...
            top of these terms and conditions. <br />
            2. PRIVACY <br />
            Please review our Privacy Policy, which also governs your visit to
            this Site, to understand our practices. <br />
            3. LINKED SITES <br />
            ...
            current as of the date you access this site. <br />
            5. DISCLAIMER OF WARRANTIES AND LIMITATION OF LIABILITY <br />
            ...
            regardless of whether such use is authorized by you. <br />
            9. COPYRIGHT AND TRADEMARK NOTICE <br />
            Except our generated dummy copy, which is free to use for private
            and commercial use, all other text is copyrighted.
            generator.lorem-ipsum.info © 2013, all rights reserved <br />
            10. INTELLECTUAL PROPERTY INFRINGEMENT CLAIMS <br />
            ...
            compliance with all local laws. <br />
            12. GENERAL <br />
