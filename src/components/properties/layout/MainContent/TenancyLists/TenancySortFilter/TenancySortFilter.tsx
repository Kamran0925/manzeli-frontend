...
import styles from "./TenancySortFilter.module.css";

interface TenancySortFilterProps {
  options: { value: string; label: string }[];
  selectedValue: string;
  onChange: (value: string) => void;
}

const TenancySortFilter: React.FC<TenancySortFilterProps> = ({
  options,
  selectedValue,
  onChange,
}) => {
...
export default TenancySortFilter;
